    ...
    <footer className="border-t border-white/[.06]">
      <div className="max-w-5xl mx-auto px-5 py-10">
        <div className="grid sm:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-wider text-white/40 mb-3">Product</p>
          ...
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-wider text-white/40 mb-3">Legal</p>
            <div className="space-y-2">
              ...
              <Link to="/impressum" className="block text-[13px] text-white/40 hover:text-white/70 transition-colors">Impressum</Link>
            </div>
          </div>
        </div>

        <div className="pt-6 border-t border-white/[.06] flex flex-wrap justify-between items-center gap-4">
          <p className="text-[12px] text-white/30">&copy; {new Date().getFullYear()} TONND</p>
