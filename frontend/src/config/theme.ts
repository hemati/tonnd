...
export const theme = {
  ...
  body: 'text-white/45',
  label: 'text-[13px] text-white/25 font-medium tracking-wide',
  muted: 'text-white/30',
  ...
  btnGhost: 'text-sm text-white/40 hover:text-white/80 transition-colors',
  ...
  navLink: 'text-[13px] text-white/40 hover:text-white/80 transition-colors',
